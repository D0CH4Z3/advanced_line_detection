...
left_fit = np.array([-3.17896222e-06, -3.84665041e-02,  2.66067728e+02])
right_fit = np.array([-4.65264420e-04,  2.99227551e-01,  1.00540351e+03])
...
result = search_around_poly(warped_binary)
